...
const buttonVariants = {
  primary:
    "bg-rspl-primary-500 text-white hover:bg-rspl-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rspl-primary-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5",
  secondary:
    "bg-rspl-secondary-600 text-white hover:bg-rspl-secondary-700 focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-rspl-secondary-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5",
